<header class="navbar navbar-header navbar-header-fixed">
    ...
    <div class="navbar-brand pl-5">
      <a href="{{route('admin.dashboard')}}" title="EL MEDINA logo. Go to EL MEDINA homepage"><img src="{{ asset('public/v2/elmedinaV2LogoTransparent.png')}}" width="190" height="45"></a>
  ...
  <div id="navbarMenu" class="navbar-menu-wrapper">
      <div class="navbar-menu-header">
        <a href="{{route('admin.dashboard')}}"><img src="{{ asset('public/v2/elmedinaV2LogoTransparent.png')}}" width="190" height="45"></a>
