...
@section ('content')
    ...
    <div class="content content-fixed">
        <div class="container-fluid pl-2 pr-2">
            ...
            <div class="row pt-3">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="uk-transition-toggle" tabindex="0">
                        <img src="{{ asset('public/template/assets/img/group_1.jpg') }}" style="border-radius: 15px 50px;" class="uk-transition-scale-up uk-transition-opaque img-about-us">
                      </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 align-bottom">
                    <p class="text-justify font-weight-light tx-14 pt-5" style="text-indent:2rem;">
            ...
            <div class="row pt-4">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 align-bottom">
                    <p class="text-justify font-weight-light tx-14"  uk-parallax="opacity: 0,1; y: 100,50; scale: 0.5,1; viewport: 0.5;" style="text-indent:2rem;">
            ...
            <div class="row pt-3">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 align-bottom">
                    <p class="text-justify font-weight-light tx-14"  uk-parallax="opacity: 0,1; y: 100,0; scale: 0.5,1; viewport: 0.5;" style="text-indent:2rem;">
