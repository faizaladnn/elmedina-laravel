							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        Terima kasih kerana membuat tempahan dengan El Medina Bekam & Recovery Spa. Anda telah berjaya membuat tempahan dengan kami. 
										Sila datang ke spa kami berdasarakan butiran tersebut : <br/><br/>
										<span style="font-weight:bold;">Tarikh :</span> {{$booking_date}}<br/>
										<span style="font-weight:bold;">Masa : </span>{{$booking_time}} <br/>
										<span style="font-weight:bold;">Perkhidmatan : </span>{{$package}} <br/>
										<span style="font-weight:bold;">Cawangan : </span>El Medina Bekam & Recovery Spa {{$branch}} <br/>
									</td>
								</tr>
								{{-- <tr>
									<td>
